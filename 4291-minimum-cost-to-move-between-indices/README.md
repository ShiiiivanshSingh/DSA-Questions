<h2><a href="https://leetcode.com/problems/minimum-cost-to-move-between-indices">4291. Minimum Cost to Move Between Indices</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code> where <code>nums</code> is <strong><span data-keyword="strictly-increasing-array">strictly increasing</span></strong>.</p>
...
<p><strong>Explanation:</strong>ââââââââââââââââââââ</p>
...
<ul>
	...
	<li><code>queries[i] = [l<sub>i</sub>, r<sub>i</sub>]</code>âââââââ</li>
